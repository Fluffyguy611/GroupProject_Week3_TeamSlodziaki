...
module.exports = function (app) {
    ...
    app.get('/add-order-customer', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var data, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    app.post('/add-order-customer', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    e_6 = _a.sent();
                    console.error(e_6);
                    res.locals.errormessage = e_6.message;
                    res.render('add-order-confirmation', req.session.order);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
